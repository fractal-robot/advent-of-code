...
public:
  Lanternfish(std::array<int, 9> &internalStates)
...
private:
  void setNewState() {
    int firstElement{m_internalStates[0]};
...
private:
  std::array<int, 9> m_internalStates{};
  int m_day{0};
};
...
int main() {
  ...
  std::string strInput;
  std::array<int, 9> internalStates{};
